...
try:
    ...
    if min_rs < 5:
        ...
        min_rs = 5
    print("Setting min. read support to {} for overall read depth of {}".format(min_rs, round((sum_depth / total_size))))
except Exception as e:
    print("Could not auto detect reads support. Falling back to {}".format(min_rs))
